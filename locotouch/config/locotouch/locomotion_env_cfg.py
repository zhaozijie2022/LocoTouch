...
def locotouch_locomotion_train_env_post_init_func(env_cfg: LocomotionBaseEnvCfg) -> None:
    env_cfg.scene.robot = Train_Robot_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")

def locotouch_locomotion_play_env_post_init_func(env_cfg: LocomotionBaseEnvCfg) -> None:
...
class LocomotionEnvCfg(LocomotionBaseEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        locotouch_locomotion_train_env_post_init_func(self)
...
class LocomotionEnvCfg_PLAY(LocomotionEnvCfg):
    def __post_init__(self) -> None:
        super().__post_init__()
        locotouch_locomotion_play_env_post_init_func(self)
