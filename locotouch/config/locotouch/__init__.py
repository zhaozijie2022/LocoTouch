...
# ----------------------------------- Random Cylinder Transport Teacher (No Tactile Test) -----------------------------------
gym.register(
    id="Isaac-RandCylinderTransportNoTactileTest-LocoTouch-v1",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": rand_cylinder_transport_no_tactile_test_env_cfg.RandCylinderTransportNoTactileTestEnvCfg,
        "rsl_rl_cfg_entry_point": rsl_rl_ppo_cfg.RandCylinderTransportNoTactileTestPPORunnerCfg,
    },
)

gym.register(
    id="Isaac-RandCylinderTransportNoTactileTest-LocoTouch-Play-v1",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": rand_cylinder_transport_no_tactile_test_env_cfg.RandCylinderTransportNoTactileTestEnvCfg_PLAY,
        "rsl_rl_cfg_entry_point": rsl_rl_ppo_cfg.RandCylinderTransportNoTactileTestPPORunnerCfg,
    },
)
"""
无触觉传感器测试任务 - 用于验证去掉触觉传感器后是否还能训练出负载运输策略

训练命令:
python locotouch/scripts/train.py --task Isaac-RandCylinderTransportNoTactileTest-LocoTouch-v1 --num_envs=20 --logger=tensorboard
python locotouch/scripts/train.py --task Isaac-RandCylinderTransportNoTactileTest-LocoTouch-v1 --num_envs=4096 --headless

测试命令:
python locotouch/scripts/play.py --task Isaac-RandCylinderTransportNoTactileTest-LocoTouch-Play-v1 --num_envs=20 --load_run=<your_run_folder>
"""
...
训练命令:
python locotouch/scripts/train.py --task Isaac-RandCylinderTransportGo2WTest-LocoTouch-v1 --num_envs=20 --logger=tensorboard
...
注意: Go2W 机器人结构更复杂，建议先训练 locomotion 预训练模型
"""
