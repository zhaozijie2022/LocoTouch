## TODO 不从go1的LocomotionBaseEnvCfg继承, 重新写go2w的locomotion env cfg
...
import locotouch.mdp_go2w as mdp
from locotouch.config.base_go2w.locomotion_base_go2w_env_cfg import (
    ActionsCfg,
    LocomotionVelocityRoughEnvCfg,
    RewardsCfg,
)

from locotouch.assets.go2w import Go2W_CFG
