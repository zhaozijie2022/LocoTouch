...
class ActorCriticPreEncoderRNNEncoder(ActorCritic):
    is_recurrent = True
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.critic_with_encoder = False if critic_pre_encoder_hidden_dims is None or critic_encoder_hidden_dims is None else True
